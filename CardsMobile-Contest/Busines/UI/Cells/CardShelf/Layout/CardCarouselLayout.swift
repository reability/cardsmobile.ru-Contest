...
enum CardCarouselLayoutSpacingMode {
    case fixed(spacing: CGFloat)
    case overlap(visibleOffset: CGFloat)
}

final class CardCarouselLayout: UICollectionViewFlowLayout {
    ...
    var spacingMode = CardCarouselLayoutSpacingMode.fixed(spacing: 40)
...
private extension CardCarouselLayout {
